...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'face', isPlayer:Bool = false, ?_id:Int = -1)
	{
		...
		if(Config.betterIcons){
			...
			animation.add('betty', [53, 54, 55], 0, false, isPlayer);
			animation.add('cube', [56, 57, 58], 0, false, isPlayer);
			animation.add('cecilia', [59, 60, 59], 0, false, isPlayer);
			animation.add('salesman', [61, 62, 61], 0, false, isPlayer);
			...
			animation.add('betty', [25, 24], 0, false, isPlayer);
			animation.add('cube', [27, 26], 0, false, isPlayer);
			animation.add('cecilia', [28, 29], 0, false, isPlayer);
			animation.add('salesman', [30, 31], 0, false, isPlayer);
		}
